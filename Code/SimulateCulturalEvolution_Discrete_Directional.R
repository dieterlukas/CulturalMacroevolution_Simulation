...
#------------------------------------------------------------------------------------------
# Simulations for the manuscript - discrete directional
#------------------------------------------------------------------------------------------
...
for (tree_variant in 1:length(tree_variants)) {
  ...
  for (selection_variant in 1:length(selection_variants)) {
    ...
    if(Option=="WNAI") write.csv(selection_results[1:counter,],file="SimulateCulture_Directional_Discrete_WNAI.csv")  
    if(Option=="PamaNyungan") write.csv(selection_results[1:counter,],file="SimulateCulture_Directional_Discrete_PamaNyungan.csv")  
