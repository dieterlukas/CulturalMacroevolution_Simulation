...
if(Option=="WNAI") {
  ...
  Americantree<-read.nexus("https://raw.githubusercontent.com/dieterlukas/CulturalMacroevolution_Simulation/master/ExampleData/WNAI_tree_forsimulation.nex")
}
...
if(Option=="PamaNyungan") {
  ...
  PamaNyungantree<-read.nexus("https://raw.githubusercontent.com/dieterlukas/CulturalMacroevolution_Simulation/master/ExampleData/PamaNyungan_tree_forsimulation.nex")
}
...
if(Option=="WNAI") {
  WNAIdata<-read.csv("https://raw.githubusercontent.com/dieterlukas/CulturalMacroevolution_Simulation/master/ExampleData/WNAI_data_forsimulation.csv")
  ...
  WNAIlocations<-read.csv("https://raw.githubusercontent.com/dieterlukas/CulturalMacroevolution_Simulation/master/ExampleData/WNAI_locations_forsimulation.csv")
...
if(Option=="PamaNyungan") {
  PamaNyungandata<-read.csv("https://raw.githubusercontent.com/dieterlukas/CulturalMacroevolution_Simulation/master/ExampleData/PamaNyungan_data_forsimulation.csv")
  ...
  PamaNyunganlocations<-read.csv("https://raw.githubusercontent.com/dieterlukas/CulturalMacroevolution_Simulation/master/ExampleData/PamaNyungan_locations_forsimulation.csv")
